...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $items = [
            ...
            ['id'=>Str::uuid(),'first_name'=>'System','last_name'=>'Admin','username'=>'systemadmin','email'=>'admin1@ict.go.ke','password'=>Hash::make('ICT@123'),'role_id'=>1,'status_id'=>2,'email_verified_at'=>now(),'created_at'=>now()],
